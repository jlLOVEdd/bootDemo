...
public class LogAspect1 {
    ...
    @Before("pointCut()")
    public void before() {
        log.debug("LogAspect1-----------method---------------before");
    }


    @Around("pointCut()")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        log.debug("LogAspect1-----------around----before");
        Object result = null;
        /*****************放行方法***************/
        try {
        ...
        log.debug("LogAspect1-----------around----after");
    ...
    public void afterReturn() {
        log.debug("LogAspect1-----------method---------------afterReturn");
    }

    @After("pointCut()")
    public void after() {
        log.debug("LogAspect1-----------method---------------after");
    }

    @AfterThrowing("pointCut()")
    public void Throwing() {
        log.debug("LogAspect1-----------method---------------Throwing");
    }
}
